namespace PT.DL.Migrations
{
    ...
    public partial class ilk : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DepartmantName = c.String(nullable: false, maxLength: 55),
                        IsActive = c.Boolean(nullable: false),
                        CreationDate = c.DateTime(nullable: false, storeType: "smalldatetime"),
                    })
                .PrimaryKey(t => t.Id)
                .Index(t => t.DepartmantName, unique: true);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SalaryLog", "UserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.SalaryLog", new[] { "UserId" });
            ...
            DropIndex("dbo.Departmans", new[] { "DepartmantName" });
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.SalaryLog");
